...
moduleForAcceptance('[AGAT] Acceptance | i i s pg bouncer sample brand l');

test('testing i-i-s-pg-bouncer-sample-brand-l', function(assert) {
  visit('/i-i-s-pg-bouncer-sample-brand-l');
