...
moduleForAcceptance('[AGAT] Acceptance | i i s pg bouncer sample producing country l');

test('testing i-i-s-pg-bouncer-sample-producing-country-l', function(assert) {
  visit('/i-i-s-pg-bouncer-sample-producing-country-l');
