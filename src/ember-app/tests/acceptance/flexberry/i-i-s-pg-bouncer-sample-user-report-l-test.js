...
moduleForAcceptance('[AGAT] Acceptance | i i s pg bouncer sample user report l');

test('testing i-i-s-pg-bouncer-sample-user-report-l', function(assert) {
  visit('/i-i-s-pg-bouncer-sample-user-report-l');
